...
class FilterAndMapTest {
    ...
    fun testKanVarslesIsTrue() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_KAN_VARSLES_TRUE)
    ...
    fun testKanVarslesIsFalse() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_KAN_VARSLES_FALSE)
        assertEquals(
            expected,
            actual,
    ...
    fun testOutdatedContactInfo() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_OUTDATED_CONTACT_INFO)
        assertEquals(
    ...
    fun testOutdatedEpostNotNumber() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_OUTDATED_EPOST_NOT_NUMBER)
        assertEquals(
            expected,
            actual,
    ...
    fun testOutdatedNumberNotEpost() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_OUTDATED_NUMBER_NOT_EPOST)
        assertEquals(
            expected,
            actual,
    ...
    fun testOutdatedEpostNumberNull() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_OUTDATED_EPOST_NUMBER_NULL)
        assertEquals(
            expected,
            actual,
    ...
    fun testOutdatedNumberEpostNull() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_OUTDATED_NUMBER_EPOST_NULL)
        assertEquals(
            expected,
            actual,
    ...
    fun testNumberAndEpostNull() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_EPOST_NUMBER_NULL)
        assertEquals(
            expected,
            actual,
    ...
    fun testFeilPersonIkkeFunnet() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_FEIL_PERSON_IKKE_FUNNET)
        assertEquals(
            expected,
            actual,
    ...
    fun testFeilStrengtFortroligAdresse() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_FEIL_STRENGT_FORTROLIG_ADRESSE)
        assertEquals(
            expected,
            actual,
    ...
    fun testFeilStrengtFortroligUtenlandskAdresse() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_FEIL_STRENGT_FORTROLIG_UTENLANDSK_ADRESSE)
        assertEquals(
            expected,
            actual,
    ...
    fun testFeilFortroligAdresse() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_FEIL_FORTROLIG_ADRESSE)
        assertEquals(
            expected,
            actual,
    ...
    fun testFeilSkjermet() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_FEIL_SKJERMET)
        assertEquals(
            expected,
            actual,
    ...
    fun testMultiplePeople() {
        ...
        val actual = filerAndMapKRRResponse(FilterTestData.INPUT_MULTIPLE_PEOPLE)
        assertEquals(
            expected,
            actual,
